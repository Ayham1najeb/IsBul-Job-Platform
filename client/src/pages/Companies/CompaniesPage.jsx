        ...
        <div className="mb-6">
          <form onSubmit={handleSearch} className="relative">
            ...
            <input
              ...
              className="block w-full pl-10 pr-24 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent shadow-sm"
            />
            <div className="absolute inset-y-0 right-0 flex items-center pr-2">
              ...
              <button
                type="submit"
                className="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-4 py-2 rounded-lg hover:shadow-lg transition-all"
              >
                Ara
              </button>
            </div>
